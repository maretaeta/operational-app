...
<template>
  <div>
    ...
    >
      <div
        class="bg-white w-[90vw] md:max-w-xl mx-auto rounded shadow-lg z-50 overflow-y-auto"
      >
        <div class="py-8 text-left px-9">
          <h2 class="text-lg lg:text-xl text-cyan-800 font-semibold mb-7">
            Create Pembelian
          </h2>
          <div v-if="currentStep === 0">
            <div class="w-full bg-gray-200 rounded-full">
              <div
                class="w-1/2 rounded-full p-1 text-xs font-medium leading-none text-center"
                :class="{
                  'text-white bg-cyan-800 rounded-l-full': currentStep === 0,
                  'text-white  rounded-r-full': currentStep === 1,
                }"
              >
                Langkah 1
              </div>
            ...
            <div class="mb-5">
              <label class="block mb-2 text-xs md:text-sm"
                >Alamat Toko
                <span class="text-red-600">*</span>
              </label>
              <input
          ...
          <div v-else-if="currentStep === 1">
            <div class="w-full bg-gray-200 rounded-full flex justify-end">
              <div
                class="w-1/2 rounded-full p-1 text-xs font-medium leading-none text-center"
                :class="{
                  'text-white bg-cyan-800 rounded-l-full w-1/2':
                    currentStep === 1,
                  'text-white  rounded-r-full': currentStep === 2,
                }"
              >
                Langkah 2
              </div>
            ...
            <div class="mt-9 mb-5">
              ...
              <input
                type="text"
                v-model="purchaseData.jenis_productSources"
            ...
            <div class="mb-4">
              ...
              <input
                type="text"
                v-model="purchaseData.nama_productSources"
                class="w-full px-4 py-2 text-xs md:text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
            ...
            <div class="mb-4">
              ...
              <input
                v-model="purchaseData.ukuran_productSources"
                class="w-full px-4 py-2 text-xs md:text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                placeholder="Ukuran"
              />
            </div>
            <div class="mb-4">
              ...
              <input
                v-model="purchaseData.jumlah_productSources"
                class="w-full px-4 py-2 text-xs md:text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                placeholder="Jumlah"
                type="number"
              />
            ...
            <div class="mb-4">
              ...
              <input
                v-model="purchaseData.pembelian_productSources"
                class="w-full px-4 py-2 text-xs md:text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
                placeholder="Harga"
                type="number"
              />
            ...
            <div class="mb-4">
              ...
              <input
                v-model="purchaseData.ongkosProses_productSources"
                class="w-full px-4 py-2 text-xs md:text-sm border rounded-md focus:border-blue-400 focus:outline-none focus:ring-1 focus:ring-blue-600"
