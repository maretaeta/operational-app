<template>
    ...
    <a-spin v-if="!isDataLoaded" size="large" class="flex items-center text-center justify-center min-h-screen w-full h-full" />
...
export default {
    ...
    mounted() {
        // Simulasi pengambilan data (gantilah dengan logika sebenarnya)
        setTimeout(() => {
