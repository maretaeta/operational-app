<template>
            ...
            <table class="min-w-full divide-y divide-gray-200 text-left">
              ...
              <tbody class="bg-white divide-y divide-gray-200 border-t border-gray-300">
                ...
                <tr v-else v-for="(item, index) in filteredToko" :key="index" class="border-b border-gray-200">
                  ...
                  <span class="text-red-500 cursor-pointer" @click="showDeleteConfirmationModal(item)">
  ...
  <div v-if="editedToko && !deleteConfirmationModal" class="fixed inset-0 flex items-center justify-center z-50">
