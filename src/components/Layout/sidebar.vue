...
<template>
    <div class="font-poppins w-1/2 md:w-52 xl:w-60 fixed md:top-0 md:left-0 h-screen lg:block bg-white z-30 transition duration-500 ease-in-out"
        ...
        <div class="mb-4 px-5 text-gray-800">
            ...
            <div @click="handleHome"
                ...
                <span class="pl-2 text-xs xl:text-sm">Dashboard</span>
            </div>
             <div @click="handlePembelian"
                    class="w-full flex items-center text-gray-800 h-10 pl-4 hover:bg-gray-30 rounded-lg cursor-pointer duration-150">
                    <font-awesome-icon icon="truck"  />
                    <span class="text-gray-800 pl-2  text-xs xl:text-sm">Pembelian</span>
                </div>
            <div @click="handleProduct"
                class="w-full flex items-center text-gray-800 h-10 pl-4 hover:bg-gray-30 rounded-lg cursor-pointer duration-150">
                <font-awesome-icon icon="boxes-stacked" />
                <span class="text-gray-800  pl-2  text-xs xl:text-sm">Product</span>
            </div>
            <div class="w-full">
                <button
                    ...
                    <span class="text-gray-800 font-medium pl-2  text-xs xl:text-sm">Penjualan</span>
                ...
                <div :class="{ 'hidden': !dropdownComprasOpen }" class="my-1 pl-2 py-1 rounded-lg bg-gray-300">
                    <div  @click="handlePenjualan"
                        ...
                        <span class="pl-2  text-xs xl:text-sm">Create Penjualan</span>
                    </div>
                    <div @click="handleDataPenjualan" 
                        ...
                        <span class=" pl-2  text-xs xl:text-sm">Data Penjualan</span>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-4 px-5 text-gray-800 mt-5">
            ...
            <div @click="handleToko"
                ...
                <span class="text-gray-800 pl-2  text-xs xl:text-sm">Toko</span>
            </div>

            <!-- <div @click="handleKaryawan"
                class="w-full flex items-center text-gray-800 h-10 pl-4 hover:bg-gray-30 rounded-lg cursor-pointer duration-150">
                <font-awesome-icon icon="users" />
                <span class="text-gray-800  pl-2  text-xs xl:text-sm">Karyawan</span>
            </div> -->
        ...
        <div class="mb-4 px-5 text-gray-800 mt-5">
            ...
            <div  @click="handlePengeluaran"
                ...
                <span class="text-gray-800 pl-2  text-xs xl:text-sm">Pengeluaran</span>
            </div>
            <div @click="handleLaporan"
                    class="w-full flex items-center text-gray-800 h-10 pl-4 hover:bg-gray-30 rounded-lg cursor-pointer duration-150">
                    <font-awesome-icon icon="money-bill-trend-up" />
                    <span class="text-gray-800 pl-2  text-xs xl:text-sm">Pendapatan</span>
            </div>
        </div>
    </div>
</template>
