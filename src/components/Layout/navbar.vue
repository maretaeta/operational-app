        ...
        <div class="w-full h-20 px-9 bg-white flex items-center justify-between shadow-md">
            <div class="flex">
                <div class="lg:hidden flex items-center mr-4 text-gray-700">
                 ...
                 <div class="w-full justify-center items-center hidden md:flex md:gap-1">
                    <img src="../../assets//logo2.png" class="w-12 xl:w-[40px]" />
                    <p class="font-semibold text-sm xl:text-base text-gray-800 pt-3">UD. ADI MULIA PROFILE</p>
                 </div>
            ...
            <div class="flex items-center relative pr-9">
                ...
                <button class="p-0 focus:outline-none duration-150 flex items-center justify-center" @click="dropDownOpen = !dropDownOpen">
                    <font-awesome-icon icon="circle-user"  class="w-5 xl:w-6 h-5 xl:h-6 mt-2 xl:mt-2 rounded-full shadow-lg border-2  hover:border-purple-600 duration-150"/>
                    <p class=" p-2 pt-7 text-xs xl:text-sm">Hi, Admin</p>
                </button>
            </div>
        </div>
